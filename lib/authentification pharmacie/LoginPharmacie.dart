...
class LoginPharmacie extends StatefulWidget {
      final String selectedLanguage;

  const LoginPharmacie({Key? key, required this.selectedLanguage}) : super(key: key);

  @override
  State<LoginPharmacie> createState() => _LoginPharmacieState();
}

class _LoginPharmacieState extends State<LoginPharmacie> {
  String email = "", password = "", name = "";String pharmacieId="";
 ...
 userLogin() async {
  ...
  try {
    ...
    try {
      DocumentSnapshot documentSnapshot = await FirebaseFirestore.instance.collection('Pharmacie').doc(uid).get();
      if (documentSnapshot.exists) {
         List<dynamic> workDays = documentSnapshot['workDays'] ?? [];
         List<String> workDaysList = workDays.map<String>((e) => e.toString()).toList();
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) =>ForgotPassword(selectedLanguage:widget.selectedLanguage,)));
                },
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SignupPharmacie(selectedLanguage:widget.selectedLanguage,)));
                    },
                    child: Text(
                      S.of(context).SignUp,
                      style: const TextStyle(
