...
import 'package:mediloc/AuthentificationMedecin/appointement.dart';
import 'package:mediloc/AuthentificationMedecin/editprofildoctor.dart';
 ...
 @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.white,
        title:
            Text(S.of(context).Profile, style: const TextStyle(color: Colors.black)),
        centerTitle: true,
        elevation: 0,
        actions: [
          IconButton(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  const CircleAvatar(
                    radius: 70,
                    backgroundImage: AssetImage('lib/assets/images/doctor.jpg'),
                  ...
                  ElevatedButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          S.of(context).Consult_Your_Appointments,
  ...
  try {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => WelcomemedecinPage(selectedLanguage: widget.selectedLanguage)),
    );
