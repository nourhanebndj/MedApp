...
class AllCategoriesPage extends StatelessWidget {
  ...
  const AllCategoriesPage({Key? key, required this.selectedLanguage}) : super(key: key);
            ...
            return FutureBuilder<void>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  List<CategoryModel> categories = myProvider.getCategoryModelList;
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => CategoryDetailPage(category: category,selectedLanguage:selectedLanguage,),
                            ),
                          );
                        },
                        child: Card(
